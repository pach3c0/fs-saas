...
window.openTicketDetail = async (ticketId) => {
  try {
    // Implementar modal de detail do ticket
    // Por ora, podemos usar um alerta simples
    alert(`Detalhe do ticket: ${ticketId}\n\nTodo o fluxo será implementado em breve.`);
  } catch (err) {
    saasToast('Erro ao abrir ticket', 'error');
  }
};
