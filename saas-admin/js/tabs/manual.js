      ...
      ${b.url ? `
        <div style="margin-top:0.625rem; display:flex; flex-direction:column; gap:0.3rem;">
          ...
          <div style="display:flex; gap:0.5rem;">
            <input type="text" readonly value="${esc(`<img src="${b.url}" style="max-width:33%; max-height:100px; border-radius:6px; margin-top:0.5rem; display:block; border:1px solid var(--border); object-fit:contain;" />`)}" style="${_inp('flex:1; font-family:monospace; font-size:0.72rem; opacity:0.8; background:#0b0f19; color:#94a3b8;')}" onclick="this.select()">
