  ...
  container.innerHTML = `
    ...
    <div style="display:flex; flex-direction:column; gap:1rem; min-height:calc(100vh - 120px);">
      ...
      <div id="newSessionCardsPanel" style="display:grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap:1rem; margin-bottom:1.5rem;">
        <!-- Card Seleção -->
        <div class="session-type-card" data-mode="selection">
           <div class="stc-ico" style="color:#eafff0;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg></div>
           <h4>Seleção</h4>
           <p>Cliente escolhe suas fotos favoritas para edição.</p>
        </div>
        <!-- Card Galeria -->
        <div class="session-type-card" data-mode="gallery">
           <div class="stc-ico" style="color:#eafff0;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg></div>
           <h4>Galeria</h4>
           <p>Fotos finalizadas prontas para visualização e download.</p>
        </div>
        <!-- Card Seleção em grupo -->
        <div class="session-type-card" data-mode="multi_selection">
           <div class="stc-ico" style="color:#eafff0;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></div>
           <h4>Seleção em grupo</h4>
           <p>Formaturas e eventos com múltiplos participantes.</p>
        </div>
        <!-- Card Galeria em Grupo -->
        <div class="session-type-card" data-mode="multi_gallery">
           <div class="stc-ico" style="color:#eafff0;"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></div>
           <h4>Galeria em Grupo</h4>
           <p>Entrega direta para vários convidados: cada um vê e baixa tudo, com seu próprio link.</p>
        </div>
        <style>
           /* Cards de criar sessão: MESMO fundo dos cards de métrica do dashboard —
              degradê escuro tingido pela cor secundária da marca (--cz-secondary).
              Sempre escuros nos 2 temas, por isso texto/ícone claros. */
           #newSessionCardsPanel .session-type-card {
              background:
                radial-gradient(130% 150% at 0% 50%, color-mix(in srgb, var(--cz-secondary) 30%, transparent) 0%, color-mix(in srgb, var(--cz-secondary) 8%, transparent) 36%, transparent 64%),
                linear-gradient(120deg, color-mix(in srgb, var(--cz-secondary) 16%, #0c1410) 0%, color-mix(in srgb, var(--cz-secondary) 7%, #0b0e13) 50%, #0b0e13 100%);
              border: 1px solid color-mix(in srgb, var(--cz-secondary) 22%, transparent);
              border-radius: var(--r-card);
              padding: 1.25rem;
              cursor: pointer;
              display: flex;
           ...
           #newSessionCardsPanel .session-type-card h4 { margin:0; font-size:1rem; font-weight:600; color:#fff; }
           #newSessionCardsPanel .session-type-card p  { margin:0; font-size:0.875rem; color:rgba(255,255,255,0.72); line-height:1.4; }
           #newSessionCardsPanel .stc-ico { display:flex; }
           .session-type-card:not([data-mode=""]):hover {
              border-color: color-mix(in srgb, var(--cz-secondary) 55%, var(--border)) !important;
              transform: translateY(-2px);
              box-shadow: 0 8px 22px color-mix(in srgb, var(--cz-secondary) 28%, transparent);
           }
        </style>
      </div>
